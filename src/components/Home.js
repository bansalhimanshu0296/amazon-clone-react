    ...
    <div className='home'>
        <div className='home__container'>
          ...
          <div className='home__row'>
            <Product id="12321341" title="The lean startup"
             price={29.99}
             image='https://images-na.ssl-images-amazon.com/images/I/51Zymoq7UnL._AC_SY400_.jpg'
             rating={5}
            />
            <Product id="49538094" title="Kenwood kMix Stand Mixer for Baking, Stylish
             Kitchen Mixer with K-beater, Dough Hook and Whisk, 5 Litre Glass Bowl"
             price={239.00}
             image="https://m.media-amazon.com/images/I/81ga10G+1UL._AC_SX679_.jpg"
             rating={4}
            />
          </div>
          <div className='home__row'>
          ...
          <div className='home__row'>
          <Product id="90829332" title="Samsung LC49RG9OSSUKEN 49' Curved LED Gaming Monitor - Super Ultra Wide
           Dual WOHD 5120 x 1440" price={1094.98} rating={4}
